...
class Template:
    ...
    def __init__(self, id: Incomplete | None = None, project_id: Incomplete | None = None, inventory_id: Incomplete | None = None, repository_id: Incomplete | None = None, environment_id: Incomplete | None = None, view_id: Incomplete | None = None, name: Incomplete | None = None, playbook: Incomplete | None = None, arguments: Incomplete | None = None, description: Incomplete | None = None, allow_override_args_in_task: Incomplete | None = None, suppress_success_alerts: Incomplete | None = None, app: Incomplete | None = None, _configuration: Incomplete | None = None) -> None: ...
    @property
    def id(self): ...
    @id.setter
    def id(self, id) -> None: ...
